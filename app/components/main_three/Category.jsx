          ...
          {selectedCategory && (
            <div style={{ maxWidth: "700px" }}>
              <ul>
                ...
                <li>
                  % Top Priority / Very Important: % of small business owners
                  that indicated that the said feature is Top Priority or Very
                ...
                <li>
                  Features Credited: Indicates whether a digital platform offers
                  a specific feature
                </li>
                <li>
